    ...
    __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_createClass___default()(Demo, [{
        ...
        value: function render() {
            return __WEBPACK_IMPORTED_MODULE_5_react__["createElement"]("div", null, __WEBPACK_IMPORTED_MODULE_5_react__["createElement"](__WEBPACK_IMPORTED_MODULE_7__src___["default"], { onChange: this.onChange, open: this.state.open, onClose: this.onTouchEnd, handler: false, level: null, afterVisibleChange: function afterVisibleChange(c) {
                ...
                } }, '\u5185\u5BB9\u533A\u5757', __WEBPACK_IMPORTED_MODULE_5_react__["createElement"]("button", { onClick: this.onSwitch, style: { height: 24, width: 100, marginLeft: 20, color: '#000', lineHeight: '24px' } }, !this.state.open ? '打开' : '关闭')));
        }
    }]);
